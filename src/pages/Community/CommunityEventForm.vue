<template>
  <DrawerBody as="form" @submit.prevent="submitForm">
    <DrawerSection class="gap-6 overflow-auto">
      <DrawerHeading> New event </DrawerHeading>
      <p>
...
async function submitForm() {
  ...
  const result = formSchema.safeParse(record);
  if (!result.success) {
